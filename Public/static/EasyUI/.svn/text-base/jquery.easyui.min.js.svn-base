...
if(!tip){
tip=$("<div class=\"validatebox-tip\">"+"<span class=\"validatebox-tip-content\">"+"</span>"+"</div>").appendTo("body");
...
if(tip) {
tip.css({ display: "block", left: box.offset().left - 10, top: box.offset().top + box.outerHeight() + 3 });
}
};
function _38a(_38f){
